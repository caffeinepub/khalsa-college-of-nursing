  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        gold: "0 4px 24px 0 rgba(180, 130, 0, 0.25)",
        navy: "0 4px 24px 0 rgba(10, 20, 80, 0.2)",
        card: "0 2px 16px 0 rgba(10, 20, 80, 0.08)",
        "card-hover": "0 8px 32px 0 rgba(10, 20, 80, 0.15)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
